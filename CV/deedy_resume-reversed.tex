...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{Rymanov Lev}{ %\urlstyle{same}\href{http://example.com}{example.com}| \href{http://example2.co}{example2.co}\\
\href{mailto:Lev-rymanov@yandex.ru}{Lev-rymanov@yandex.ru} | \href{tel:11111111111}{111.111.1111}
}
...
\runsubsection{My University Experience}
...
\location{Expected June 2028 | Moscow}
